...
sudo git clone https://github.com/TheModeler99/fully-automated-infras-project.git /tmp/fully-automated-infras-project
sudo cp /tmp/fully-automated-infras-project/node-exporter.service /etc/systemd/system/node-exporter.service
